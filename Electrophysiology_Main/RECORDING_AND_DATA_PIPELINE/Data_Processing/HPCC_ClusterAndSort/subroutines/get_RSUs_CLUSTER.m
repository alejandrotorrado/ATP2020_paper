function [cell_set_RSU,rsu_idx] = get_RSUs_CLUSTER(cell_set,qthresh,dep,...
...
fprintf('Negpostime threshold is: %u%%.\n\n',negposT);
fprintf('Tailslope threshold is: %u%%.\n\n',tailslopeT);
...
for dd = 1:length(cell_set)
    ...
    switch dataset
        ...
        case {'recov','CPPrecov'}
            % fixed number of recorded days, from MD4 to ER5 (included)
            daysRecorded = 5;
        case 'SHANK24'
            daysRecorded = 1;
