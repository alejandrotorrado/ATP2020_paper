function [datback, p_out, trimvec] = alignandcluster_HPC_NEW_BETA (sweepdat,thischan,yy,houredges,subidx,scrubbedidx,timestamps,doInterp,interp_samp, Mdl, nminrng, nswprng,maxclusts, SUBSET)
...
block.clust     = klustakwikRJ_hpc_NEW_BETA( ClusterSet, minclusts, maxclusts, 'notverbose', chanblockcode, SUBSET );
