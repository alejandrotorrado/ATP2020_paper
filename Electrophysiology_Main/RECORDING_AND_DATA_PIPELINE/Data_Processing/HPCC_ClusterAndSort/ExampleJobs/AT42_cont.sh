...
#SBATCH --job-name=AT42c
#SBATCH --output=/home/atorrpac/job_outputs/AT42c_out.txt
#SBATCH --error=/home/atorrpac/job_outputs/AT42c_err.txt
#SBATCH --ntasks=1
#SBATCH -n 4
#SBATCH --mem=40000
...
# Argument list
anim="'AT42'"	# animal name (e.g. AT30)
