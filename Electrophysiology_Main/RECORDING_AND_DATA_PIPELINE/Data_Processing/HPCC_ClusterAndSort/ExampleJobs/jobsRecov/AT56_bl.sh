...
#SBATCH --job-name=AT56bl
#SBATCH --output=/home/atorrpac/job_outputs/AT56bl_out.txt
#SBATCH --error=/home/atorrpac/job_outputs/AT56bl_err.txt
#SBATCH --ntasks=1
#SBATCH -n 1
#SBATCH --mem=25000
...
# Argument list
anim="'AT56'"	# animal name (e.g. AT30)
...
chsize=36	# chunk size (in hours). 0 for whole experiment
tstart=0	# chunk start time. should be 0 if chsize=0
tstop=36	# chunk end time. should be 0 if chsize=0
