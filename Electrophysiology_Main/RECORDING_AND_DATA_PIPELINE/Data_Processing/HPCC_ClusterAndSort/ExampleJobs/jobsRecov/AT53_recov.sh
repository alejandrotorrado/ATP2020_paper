...
#SBATCH --job-name=AT53r
#SBATCH --output=/home/atorrpac/job_outputs/AT53r_out2.txt
#SBATCH --error=/home/atorrpac/job_outputs/AT53r_err2.txt
#SBATCH --ntasks=1
#SBATCH -n 1
#SBATCH --mem=25000
...
# Argument list
anim="'AT53'"	# animal name (e.g. AT30)
