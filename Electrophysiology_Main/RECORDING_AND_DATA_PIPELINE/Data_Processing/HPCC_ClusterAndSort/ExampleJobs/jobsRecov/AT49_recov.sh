...
#SBATCH --partition=neuro-compute
#SBATCH --time=48:00:00
#SBATCH --job-name=AT49r
#SBATCH --output=/home/atorrpac/job_outputs/AT49r_out.txt
#SBATCH --error=/home/atorrpac/job_outputs/AT49r_err.txt
#SBATCH --ntasks=1
#SBATCH -n 8
#SBATCH --mem=25000
