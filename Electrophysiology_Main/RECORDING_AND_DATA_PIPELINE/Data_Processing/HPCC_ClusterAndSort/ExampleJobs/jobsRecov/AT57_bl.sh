...
#SBATCH --job-name=AT57bl
#SBATCH --output=/home/atorrpac/job_outputs/AT57bl_out.txt
#SBATCH --error=/home/atorrpac/job_outputs/AT57bl_err.txt
#SBATCH --ntasks=1
#SBATCH -n 1
#SBATCH --mem=25000
...
# Argument list
anim="'AT57'"	# animal name (e.g. AT30)
