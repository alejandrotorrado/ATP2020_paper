...
#SBATCH --job-name=AT50r
#SBATCH --output=/home/atorrpac/job_outputs/AT50r_out.txt
#SBATCH --error=/home/atorrpac/job_outputs/AT50r_err.txt
#SBATCH --ntasks=1
#SBATCH -n 1
#SBATCH --mem=25000
...
chanstart=13	# start clustering from this channel (set >1 if you want to skip channels)
