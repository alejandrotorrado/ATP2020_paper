...
#SBATCH --job-name=AT56r2
#SBATCH --output=/home/atorrpac/job_outputs/AT56r2_out.txt
#SBATCH --error=/home/atorrpac/job_outputs/AT56r2_err.txt
#SBATCH --ntasks=1
#SBATCH -n 1
#SBATCH --mem=25000
...
chanstart=16	# start clustering from this channel (set >1 if you want to skip channels)
