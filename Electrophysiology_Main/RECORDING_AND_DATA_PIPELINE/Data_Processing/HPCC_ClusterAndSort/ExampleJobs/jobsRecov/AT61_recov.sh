...
#SBATCH --job-name=AT61r
#SBATCH --output=/home/atorrpac/job_outputs/AT61r_out.txt
#SBATCH --error=/home/atorrpac/job_outputs/AT61r_err.txt
#SBATCH --ntasks=1
#SBATCH -n 1
#SBATCH --mem=25000
...
# Argument list
anim="'AT61'"	# animal name (e.g. AT30)
