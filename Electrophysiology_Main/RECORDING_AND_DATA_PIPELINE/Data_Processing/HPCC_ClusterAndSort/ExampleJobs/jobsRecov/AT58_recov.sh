...
#SBATCH --job-name=AT58r
#SBATCH --output=/home/atorrpac/job_outputs/AT58r_out.txt
#SBATCH --error=/home/atorrpac/job_outputs/AT58r_err.txt
#SBATCH --ntasks=1
#SBATCH -n 1
#SBATCH --mem=25000
...
# Argument list
anim="'AT58'"	# animal name (e.g. AT30)
