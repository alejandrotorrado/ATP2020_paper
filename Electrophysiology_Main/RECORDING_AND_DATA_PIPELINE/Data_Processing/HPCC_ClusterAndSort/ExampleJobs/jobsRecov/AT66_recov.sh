...
#SBATCH --job-name=AT66r
#SBATCH --output=/home/atorrpac/job_outputs/AT66r_out.txt
#SBATCH --error=/home/atorrpac/job_outputs/AT66r_err.txt
#SBATCH --ntasks=1
#SBATCH -n 1
#SBATCH --mem=20000
...
chanstart=11	# start clustering from this channel (set >1 if you want to skip channels)
