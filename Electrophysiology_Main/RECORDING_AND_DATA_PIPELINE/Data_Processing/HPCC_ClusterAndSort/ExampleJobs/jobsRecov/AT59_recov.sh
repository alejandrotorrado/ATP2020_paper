...
#SBATCH --job-name=AT59r
#SBATCH --output=/home/atorrpac/job_outputs/AT59r_out.txt
#SBATCH --error=/home/atorrpac/job_outputs/AT59r_err.txt
#SBATCH --ntasks=1
#SBATCH -n 1
#SBATCH --mem=25000
...
# Argument list
anim="'AT59'"	# animal name (e.g. AT30)
