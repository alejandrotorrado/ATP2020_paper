...
#SBATCH --job-name=AT67r_2
#SBATCH --output=/home/atorrpac/job_outputs/AT67r_out2.txt
#SBATCH --error=/home/atorrpac/job_outputs/AT67r_err2.txt
#SBATCH --ntasks=1
#SBATCH -n 1
#SBATCH --mem=20000
...
chanstart=23	# start clustering from this channel (set >1 if you want to skip channels)
