...
#SBATCH --job-name=AT64r
#SBATCH --output=/home/atorrpac/job_outputs/AT64r_out.txt
#SBATCH --error=/home/atorrpac/job_outputs/AT64r_err.txt
#SBATCH --ntasks=1
#SBATCH -n 1
#SBATCH --mem=20000
...
# Argument list
anim="'AT64'"	# animal name (e.g. AT30)
