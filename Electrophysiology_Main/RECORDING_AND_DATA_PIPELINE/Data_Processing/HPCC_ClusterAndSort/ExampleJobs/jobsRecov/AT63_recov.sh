...
#SBATCH --job-name=AT63r
#SBATCH --output=/home/atorrpac/job_outputs/AT63r_out.txt
#SBATCH --error=/home/atorrpac/job_outputs/AT63r_err.txt
#SBATCH --ntasks=1
#SBATCH -n 1
#SBATCH --mem=25000
...
# Argument list
anim="'AT63'"	# animal name (e.g. AT30)
