...
#SBATCH --job-name=AT45r
#SBATCH --output=/home/atorrpac/job_outputs/AT45r_out.txt
#SBATCH --error=/home/atorrpac/job_outputs/AT45r_err.txt
#SBATCH --ntasks=1
#SBATCH -n 8
#SBATCH --mem=20000
...
# Argument list
anim="'AT45'"	# animal name (e.g. AT30)
