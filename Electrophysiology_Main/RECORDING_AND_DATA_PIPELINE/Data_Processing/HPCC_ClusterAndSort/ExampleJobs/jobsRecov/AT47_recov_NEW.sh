...
#SBATCH --job-name=AT47rn_2
#SBATCH --output=/home/atorrpac/job_outputs/AT47rn_out2.txt
#SBATCH --error=/home/atorrpac/job_outputs/AT47rn_err2.txt
#SBATCH --ntasks=1
#SBATCH -n 8
#SBATCH --mem=25000
...
# Argument list
anim="'AT47'"	# animal name (e.g. AT30)
...
chanstart=15	# start clustering from this channel (set >1 if you want to skip channels)
subset=5000000  # size of subset of spikes to be used for clustering
