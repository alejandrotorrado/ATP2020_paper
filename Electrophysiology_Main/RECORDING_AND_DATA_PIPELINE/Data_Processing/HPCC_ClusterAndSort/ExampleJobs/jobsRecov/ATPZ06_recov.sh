...
#SBATCH --job-name=ATPZ06r
#SBATCH --output=/home/atorrpac/job_outputs/ATPZ06r_out.txt
#SBATCH --error=/home/atorrpac/job_outputs/ATPZ06r_err.txt
#SBATCH --ntasks=1
#SBATCH -n 1
#SBATCH --mem=25000
...
# Argument list
anim="'ATPZ06'"	# animal name (e.g. AT30)
