...
#SBATCH --job-name=AT55r
#SBATCH --output=/home/atorrpac/job_outputs/AT55r_out.txt
#SBATCH --error=/home/atorrpac/job_outputs/AT55r_err.txt
#SBATCH --ntasks=1
#SBATCH -n 1
#SBATCH --mem=25000
...
# Argument list
anim="'AT55'"	# animal name (e.g. AT30)
