...
#SBATCH --job-name=AT52r
#SBATCH --output=/home/atorrpac/job_outputs/AT52r_out.txt
#SBATCH --error=/home/atorrpac/job_outputs/AT52r_err.txt
#SBATCH --ntasks=1
#SBATCH -n 1
#SBATCH --mem=25000
...
# Argument list
anim="'AT52'"	# animal name (e.g. AT30)
