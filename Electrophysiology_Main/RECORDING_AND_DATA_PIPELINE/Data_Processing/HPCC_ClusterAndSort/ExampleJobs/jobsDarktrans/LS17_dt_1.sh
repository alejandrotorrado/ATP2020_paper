...
#SBATCH --output=/home/atorrpac/job_outputs/LS17_dt1_out.txt
#SBATCH --error=/home/atorrpac/job_outputs/LS17_dt1_err.txt
#SBATCH --ntasks=1
#SBATCH -n 1
#SBATCH --mem=10000
...
tstart=106	# chunk start time. should be 0 if chsize=0
tstop=110	# chunk end time. should be 0 if chsize=0
