...
#SBATCH --job-name=LS15_dt_1
#SBATCH --output=/home/atorrpac/job_outputs/LS15_dt1_out.txt
#SBATCH --error=/home/atorrpac/job_outputs/LS15_dt1_err.txt
#SBATCH --ntasks=1
#SBATCH -n 8
#SBATCH --mem=10000
...
tstart=58	# chunk start time. should be 0 if chsize=0
tstop=62	# chunk end time. should be 0 if chsize=0
