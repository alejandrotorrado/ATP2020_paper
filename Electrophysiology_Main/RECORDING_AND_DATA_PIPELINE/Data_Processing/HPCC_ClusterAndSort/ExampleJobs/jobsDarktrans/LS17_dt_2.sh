...
#SBATCH --job-name=LS17_dt_2
#SBATCH --output=/home/atorrpac/job_outputs/LS17_dt2_out.txt
#SBATCH --error=/home/atorrpac/job_outputs/LS17_dt2_err.txt
#SBATCH --ntasks=1
#SBATCH -n 8
#SBATCH --mem=10000
...
tstart=118	# chunk start time. should be 0 if chsize=0
tstop=122	# chunk end time. should be 0 if chsize=0
