...
#SBATCH --job-name=LS17_dt_3
#SBATCH --output=/home/atorrpac/job_outputs/LS17_dt3_out.txt
#SBATCH --error=/home/atorrpac/job_outputs/LS17_dt3_err.txt
#SBATCH --ntasks=1
#SBATCH -n 8
#SBATCH --mem=25000
...
# Argument list
anim="'LS17'"	# animal name (e.g. AT30)
...
tstart=142	# chunk start time. should be 0 if chsize=0
tstop=146	# chunk end time. should be 0 if chsize=0
