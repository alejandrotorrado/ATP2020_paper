...
#SBATCH --job-name=LS15_dt_3
#SBATCH --output=/home/atorrpac/job_outputs/LS15_dt3_out.txt
#SBATCH --error=/home/atorrpac/job_outputs/LS15_dt3_err.txt
#SBATCH --ntasks=1
#SBATCH -n 8
#SBATCH --mem=10000
...
# Argument list
anim="'LS15'"	# animal name (e.g. AT30)
...
tstart=94	# chunk start time. should be 0 if chsize=0
tstop=98	# chunk end time. should be 0 if chsize=0
