...
#SBATCH --output=/home/atorrpac/job_outputs/LS17_dt5_out.txt
#SBATCH --error=/home/atorrpac/job_outputs/LS17_dt5_err.txt
#SBATCH --ntasks=1
#SBATCH -n 1
#SBATCH --mem=15000
...
tstart=154	# chunk start time. should be 0 if chsize=0
tstop=158	# chunk end time. should be 0 if chsize=0
