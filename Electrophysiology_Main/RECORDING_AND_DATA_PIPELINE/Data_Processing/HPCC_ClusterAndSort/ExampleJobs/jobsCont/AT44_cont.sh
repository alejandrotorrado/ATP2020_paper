...
#SBATCH --job-name=AT44c
#SBATCH --output=/home/atorrpac/job_outputs/AT44c_out.txt
#SBATCH --error=/home/atorrpac/job_outputs/AT44c_err.txt
#SBATCH --ntasks=1
#SBATCH -n 4
#SBATCH --mem=40000
...
# Argument list
anim="'AT44'"	# animal name (e.g. AT30)
