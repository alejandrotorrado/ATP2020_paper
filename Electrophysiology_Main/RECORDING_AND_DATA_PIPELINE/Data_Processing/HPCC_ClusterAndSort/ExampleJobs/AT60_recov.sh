...
#SBATCH --job-name=AT60r
#SBATCH --output=/home/atorrpac/job_outputs/AT60r_out.txt
#SBATCH --error=/home/atorrpac/job_outputs/AT60r_err.txt
#SBATCH --ntasks=1
#SBATCH -n 1
#SBATCH --mem=25000
...
# Argument list
anim="'AT60'"	# animal name (e.g. AT30)
...
hem="'L'"	# deprived hemisphere (L or R) note: for AT60, hemis were flipped. L is actually R (ch1-16)
