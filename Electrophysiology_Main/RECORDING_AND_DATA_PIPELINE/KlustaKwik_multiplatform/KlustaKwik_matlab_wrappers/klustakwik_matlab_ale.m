...
if ~isempty(strfind(computer,'MAC')),
    ...
    if strcmp(myname,'AlesMac')
        kexecute = [klustapath filesep 'alesmac' filesep 'KlustaKwik']; % this is the executable compiled on ATP's MacBookPro
    else
...
eval(command_string);
t1 = toc(t0);
disp(['Clustering took ',num2str(t1), ' seconds.']);
