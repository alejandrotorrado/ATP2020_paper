function [out_score,raw_score,feature_mtx] = auto_video_score_PyWrap_Quiet(input_data, ml_model_path, tx, bin_size, Fs, pc_name)
...
for jj = 1:size(bin_edges,2)-1
    ...
    % 13. quiet (head only) movement z-score
    ...
    quiet_data      = input_data(t0:t1,5);
    emg_data        = input_data(t0:t1,6);
