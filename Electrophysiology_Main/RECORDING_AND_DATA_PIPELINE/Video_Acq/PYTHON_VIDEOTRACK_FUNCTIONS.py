...
def videoTrack_DARK(vidframe,vidparams,genparams,raw_mvt,track,framecounter,framestart,verbose=False):
    
    
    # find contours of white pixel blobs
    contours, hierarchy = cv2.findContours(vidframe,cv2.RETR_EXTERNAL,cv2.CHAIN_APPROX_SIMPLE)
...
def videoTrack_LIGHT(vidframe,vidparams,genparams,raw_mvt,track,framecounter,framestart,verbose=False):
