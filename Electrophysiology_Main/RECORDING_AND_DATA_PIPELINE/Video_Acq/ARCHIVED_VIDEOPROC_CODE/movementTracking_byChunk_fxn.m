...
for f_chunk = 1:nframe_chunks
    ...
    if ~isempty(csv)
        ...
        movement_1(start_pos:end_pos,1) = temp_mvt1(:,1);
    end
    ...
    if ~ isempty(csv)
        ...
        movement_2(start_pos:end_pos,1) = temp_mvt2(:,1);
    end
    ...
    if mod(f_chunk,10) == 0
        % animal 1
        temp_savename1 = [saveloc filesep 'TEMP' filesep animal1 '_tempsave_chunk_' num2str(f_chunk) '.mat'];
        save(temp_savename1,'movement_1','smoothed_mvt_1','track_1','-v7.3')
        
        % animal 2
        temp_savename2 = [saveloc filesep 'TEMP' filesep animal2 '_tempsave_chunk_' num2str(f_chunk) '.mat'];
...
% remove temp files
delete([saveloc filesep 'TEMP' filesep '*']);
