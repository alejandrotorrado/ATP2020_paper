%% Analysis_Continuous_MLS - VARIANT
%
% Alejandro Torrado Pacheco - 2017
%
% _________________________ IMPORTANT NOTE ________________________________
%
% This is a variant of the main analysis script. It is set up as a loop
% that will first process control hemisphere, then re-opened hemisphere
% ones. The data will all be saved in a single file within a data structure
% (named recov_analysis) for post-processing. This variant of the script
...
for dep = 0:1
    ...
    % dep = 1; % deprived (1) or control (0) hemisphere % THIS IS NOW COMMENTED OUT
    ...
    normalize = 0; % normalize FRs - DO NOT NORMALIZE IN 'VARIANT' MODE
...
% save structure to file - make sure to change the file name and path here!
recov_analysis.G_bin = G_bin;
if ismac
    sfile = '/Users/atorrado/Desktop/MLS_DATA/recov_analysis_CPP2_NEW_May2020.mat';
elseif ispc
    sfile = 'Z:\ATP_MAIN\DATA\Eye_Reopening\recov_DATA\recov_analysis_CPP2_NEW_May2020.mat';
end
