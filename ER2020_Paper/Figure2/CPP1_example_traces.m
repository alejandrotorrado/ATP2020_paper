...
%
% Plot example FR traces for Eye Re-opening experiments with CPP injection
% on ER1 (Fig 2C).
...
loadfile = [load_dir filesep 'recov_analysis_CPP1.mat'];
rload = load(loadfile);
...
erx0_1 = (7.0*24 + 2.5)*3600 / G_bin;
erx1_1 = (7.0*24 + 4.0)*3600 / G_bin;
