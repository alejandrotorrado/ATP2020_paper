...
if ismac
    frload = load('/Volumes/turrigiano-lab/ATP_MAIN/DATA/Dissertation_Data/ER2020/ER_Fig1/recov_analysis.mat');
...
elseif ispc
    frload = load('Z:\ATP_MAIN\DATA\Dissertation_Data\ER2020\ER_Fig1\recov_analysis.mat');
    rload = load('Z:\ATP_MAIN\DATA\Dissertation_Data\ER2020\ER_FigS1\recov_bootstrap_2.mat');
end
